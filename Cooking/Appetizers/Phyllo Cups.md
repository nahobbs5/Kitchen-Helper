...
1. **Prep and Sauté:**
    ...
    - Add garlic and chopped spinach. Cook until spinach is wilted (or warmed through if using frozen spinach).
    - Season with salt, pepper, and red pepper flakes if using. Remove from heat.
2. **Make the Filling:**
    - In a bowl, combine the spinach mixture with feta and cream cheese.
    - Mix until smooth and creamy. Adjust seasoning if needed.
3. **Assemble the Cups:**
    - Arrange phyllo cups on a baking sheet.
    - Spoon the spinach and feta mixture into each cup, filling generously.
4. **Bake:**
    - Bake at 350°F for 10-12 minutes, or until the cups are golden and the filling is warmed through.
5. **Serve:**
    - Garnish with a sprinkle of extra feta or fresh parsley if desired.
    - Serve warm!
