...
export const kitchenStyles = StyleSheet.create({
  ...
  ovenConverterValueRow: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 12,
  },
  ovenConverterValueBlock: {
    flex: 1,
    minWidth: 128,
    gap: 4,
  },
